...
def help(message, session):
    return '''Welcome to follow!
        ...
        You can get information through these commands
        ...
        recent:Get the latest articles
        help:Get help.
        weather:Get weather
        idcard:Obtain ID card information
        Such as idcard:61048119xxxxxxxxxx
        music:Music search
        Such as music:Happy cloudy
...
class CommandHandler():
    ...
    def run(self, title):
        ...
        if cmd:
            ...
            return "No related commands were found, please enter hepme for help."
    ...
    def handler(self):
        ...
        if self.userinfo.isAdmin and not self.userinfo.isPasswordSet:
            ...
            if passwd.upper() == get_md5(get_md5(info)).upper():
                ...
                self.savesession()
                return "After the verification is passed, please enter the command or the command code to be executed: enter helpme for help"
            else:
                if self.userinfo.Count >= 3:
                    self.userinfo = WxUserInfo()
                    self.savesession()
                    return "Verified times exceeded"
